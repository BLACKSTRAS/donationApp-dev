...
const sharedProfileDir = "C:\\Users\\black\\Desktop\\donationApp\\shared\\images\\profiles"; /* ใช้ pathตัวเองนะไม่งั้นแตก */
const sharedAudioDir = "C:\\Users\\black\\Desktop\\donationApp\\shared\\audios\\voiceRef"; /* ใช้ pathตัวเองนะไม่งั้นแตก */
